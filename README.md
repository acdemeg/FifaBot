...
1. `-logging` - all screenshots will be placed in _**logs/TestImages**_, the log will be written to _**logs/fifa19bot.log**_
...
debugging purposes and analysis of the "replay" from `logs/TestImages`
